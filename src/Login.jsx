...
function Login(props){
    return(
        ...
        <div className="register bg-dark-subtle sh p-3 border-2 w-auto d-flex flex-column align-items-center justify-content-cente mt-3 rounded-3">
            ...
            <CustomInput labeltext ='last name : ' placeholdertext='family name' type="text" size=''></CustomInput>
            </div>
            <div className="email w-100">
            <CustomInput labeltext ='please enter your email ' placeholdertext='email' type="email" size=''></CustomInput>

            </div>
            <div className="pass  d-flex gap-2 align-items-center justify-content-center">
            <CustomInput labeltext ='create password ' placeholdertext='password' type="password" size=''></CustomInput>
            <CustomInput labeltext ='Confirm password ' placeholdertext='Confirm password' type="password" size=''></CustomInput>
            </div>
